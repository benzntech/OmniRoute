...
function setupContentSecurityPolicy() {
  // Disabled manual CSP injection to allow Next.js server headers to take precedence.
  // This resolves blank screen issues caused by redundant or clashing CSP definitions.
  return;
}
